...
from fosslight_dependency.package_manager.Buildroot import Buildroot
...
def analyze_dependency(package_manager_name, input_dir, output_dir, pip_activate_cmd='', pip_deactivate_cmd='',
    ...
    elif package_manager_name == const.BUILDROOT:
        package_manager = Buildroot(input_dir, output_dir)
    else:
