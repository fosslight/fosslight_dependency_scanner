    ...
    def parse_oss_information(self, f_name):
        ...
        try:
            ...
            for d in json_data:
                ...
                self.purl_dict[f'{oss_init_name}({oss_item.version})'] = dep_item.purl
                ...
                sheet_list.append([dep_item.purl, oss_item.name, oss_item.version,
                                   ','.join(oss_item.license), oss_item.download_location, oss_item.homepage,
